...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.label.setStyleSheet('color:#fff;  font-size:30px')
        ...
        self.button.setStyleSheet("background-color:#252525")
    ...
    def dected_weather(self):
        ...
        # get minimum temperature
            ...
            text = QTextEdit(dlg)
            text.setStyleSheet('Color:#fff; font-size:20px; border:0px')
